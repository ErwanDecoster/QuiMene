...
enum ProfileShareLink {
    ...
    static func url(id: UUID, name: String, avatarKind: String, avatarValue: String, paletteID: String) -> URL? {
    ...
    static func parse(_ url: URL) -> Payload? {
        ...
        return Payload(id: id, name: name, avatarKind: avatarKind, avatarValue: avatarValue, paletteID: paletteID)
    }
}
