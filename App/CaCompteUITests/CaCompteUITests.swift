...
@MainActor
final class CaCompteUITests: XCTestCase {
  ...
  ///   test) fait repartir `CaCompteApp` sur un magasin vide, dédié aux tests d'interface (voir
  ///   `CaCompteApp.isUITesting`) — sans ça, les joueurs créés par un parcours s'accumulent
