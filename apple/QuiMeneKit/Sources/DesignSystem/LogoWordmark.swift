...
/// Charte graphique §11.2 — wordmark « Qui Mène ? » en Outfit SemiBold, tracking −1 %.
...
/// ces dix caractères l'est, en SVG dans le catalogue d'assets (`logo/wordmark`).
