package com.quimene.designsystem.tokens
...
/** Thème sombre effectivement résolu par [com.quimene.designsystem.theme.QuiMeneTheme] — à
 ...
 * [dynamicAppColors] et `QuiMeneTheme` pour le cas dynamique, aujourd'hui le cas par défaut.
 *
 ...
 * `dynamicLightColorScheme`/`dynamicDarkColorScheme`) — utilisé par `QuiMeneTheme` quand le
