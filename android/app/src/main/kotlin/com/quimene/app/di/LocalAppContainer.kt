...
/** Fourni à la racine de la composition par [com.quimene.app.MainActivity] — chaque écran y
...
val LocalAppContainer =
    staticCompositionLocalOf<AppContainer> {
        error("LocalAppContainer n'est fourni qu'à l'intérieur de QuiMeneTheme/QuiMeneApp.")
    }
