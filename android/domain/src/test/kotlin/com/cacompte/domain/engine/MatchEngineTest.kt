...
import com.cacompte.domain.testing.roundDraft
import com.cacompte.domain.testing.testCatalog
import com.cacompte.domain.testing.testDefinition
import com.cacompte.domain.testing.testParticipant
...
class MatchEngineTest {
    ...
    fun `reduce applies a single event using the injected clock`() {
        ...
        val rules =
            com.cacompte.domain.testing
                .TestGameRules(definition.engine)

        val initial =
            com.cacompte.domain.model.MatchState.create(
