 ...
 * l'appelant ([com.cacompte.domain.engine.MatchEngine]) est la même "nouvelle" MatchState dans
 ...
 * ultérieure passe par [com.cacompte.domain.engine.MatchEngine] (`reduce`/`replay`) — jamais un
...
data class MatchState internal constructor(
     ...
     * [com.cacompte.domain.engine.MatchEngine], dans le même module, y accède. */
    internal fun apply(
        event: MatchEvent,
        rules: GameRules,
