package com.cacompte.catalog.golden

import com.cacompte.catalog.GameCatalogEmbedded
import com.cacompte.catalog.games.tarotHandScoreDetail
import com.cacompte.catalog.games.wizardBidScoreDetail
import com.cacompte.catalog.games.yamsCategoryScoreDetail
    ...
    fun replay(golden: GoldenFile) {
        ...
        for (expected in golden.expected.insights) {
            ...
            when (val value = actual.value) {
                is com.cacompte.domain.stats.Insight.Value.Single -> {
                ...
                is com.cacompte.domain.stats.Insight.Value.PerParticipant -> {
