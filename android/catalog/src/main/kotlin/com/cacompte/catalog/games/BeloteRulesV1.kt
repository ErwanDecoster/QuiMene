...
/**
 * Réservation de place pour le moteur Belote (équipes, seuil configurable) — **portage réel à
 * l'étape C**, hors périmètre de cette session. Voir la note complète sur [SkyjoRulesV1] : échec
 * bruyant volontaire plutôt qu'un repli silencieux sur la logique générique, qui calculerait un
 * score Belote faux.
 */
class BeloteRulesV1 : GameRules {
    ...
    private fun notPortedYet(): Nothing =
        TODO("BeloteRulesV1 — porté à l'étape C (docs/11-portage-android.md), pas cette session")
