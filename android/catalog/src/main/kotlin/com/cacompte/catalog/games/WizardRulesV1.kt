...
/**
 * Réservation de place pour le moteur Wizard (annonce/résultat, nombre de manches dépendant du
 * nombre de joueurs) — **portage réel à l'étape C**, hors périmètre de cette session. Voir la
 * note complète sur [SkyjoRulesV1] : échec bruyant volontaire plutôt qu'un repli silencieux sur
 * la logique générique, qui calculerait un score Wizard faux.
 */
class WizardRulesV1 : GameRules {
    ...
    private fun notPortedYet(): Nothing =
        TODO("WizardRulesV1 — porté à l'étape C (docs/11-portage-android.md), pas cette session")
